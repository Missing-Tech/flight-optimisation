...
class AircraftPerformanceModel:
    ...
    def calculate_flight_characteristics(self, flight_path: FlightPath) -> FlightPath:
        """
    ...
    def calculate_coarse_characteristics(self, flight_path: FlightPath) -> FlightPath:
        """
